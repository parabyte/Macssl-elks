...
#define MBEDTLS_X509_BADCERT_EXPIRED             (1UL << 0)  /**< The certificate validity has expired. */
#define MBEDTLS_X509_BADCERT_REVOKED             (1UL << 1)  /**< The certificate has been revoked (is on a CRL). */
#define MBEDTLS_X509_BADCERT_CN_MISMATCH         (1UL << 2)  /**< The certificate Common Name (CN) does not match with the expected CN. */
#define MBEDTLS_X509_BADCERT_NOT_TRUSTED         (1UL << 3)  /**< The certificate is not correctly signed by the trusted CA. */
#define MBEDTLS_X509_BADCRL_NOT_TRUSTED          (1UL << 4)  /**< The CRL is not correctly signed by the trusted CA. */
#define MBEDTLS_X509_BADCRL_EXPIRED              (1UL << 5)  /**< The CRL is expired. */
#define MBEDTLS_X509_BADCERT_MISSING             (1UL << 6)  /**< Certificate was missing. */
#define MBEDTLS_X509_BADCERT_SKIP_VERIFY         (1UL << 7)  /**< Certificate verification was skipped. */
#define MBEDTLS_X509_BADCERT_OTHER               (1UL << 8)  /**< Other reason (can be used by verify callback) */
#define MBEDTLS_X509_BADCERT_FUTURE              (1UL << 9)  /**< The certificate validity starts in the future. */
#define MBEDTLS_X509_BADCRL_FUTURE               (1UL << 10) /**< The CRL is from the future */
#define MBEDTLS_X509_BADCERT_KEY_USAGE           (1UL << 11) /**< Usage does not match the keyUsage extension. */
#define MBEDTLS_X509_BADCERT_EXT_KEY_USAGE       (1UL << 12) /**< Usage does not match the extendedKeyUsage extension. */
#define MBEDTLS_X509_BADCERT_NS_CERT_TYPE        (1UL << 13) /**< Usage does not match the nsCertType extension. */
#define MBEDTLS_X509_BADCERT_BAD_MD              (1UL << 14) /**< The certificate is signed with an unacceptable hash. */
#define MBEDTLS_X509_BADCERT_BAD_PK              (1UL << 15) /**< The certificate is signed with an unacceptable PK alg (eg RSA vs ECDSA). */
#define MBEDTLS_X509_BADCERT_BAD_KEY             (1UL << 16) /**< The certificate is signed with an unacceptable key (eg bad curve, RSA too short). */
#define MBEDTLS_X509_BADCRL_BAD_MD               (1UL << 17) /**< The CRL is signed with an unacceptable hash. */
#define MBEDTLS_X509_BADCRL_BAD_PK               (1UL << 18) /**< The CRL is signed with an unacceptable PK alg (eg RSA vs ECDSA). */
#define MBEDTLS_X509_BADCRL_BAD_KEY              (1UL << 19) /**< The CRL is signed with an unacceptable key (eg bad curve, RSA too short). */
