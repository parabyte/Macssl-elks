 ...
 */
#define MBEDTLS_OID_X509_EXT_AUTHORITY_KEY_IDENTIFIER    (1UL << 0)
#define MBEDTLS_OID_X509_EXT_SUBJECT_KEY_IDENTIFIER      (1UL << 1)
#define MBEDTLS_OID_X509_EXT_KEY_USAGE                   (1UL << 2)
#define MBEDTLS_OID_X509_EXT_CERTIFICATE_POLICIES        (1UL << 3)
#define MBEDTLS_OID_X509_EXT_POLICY_MAPPINGS             (1UL << 4)
#define MBEDTLS_OID_X509_EXT_SUBJECT_ALT_NAME            (1UL << 5)
#define MBEDTLS_OID_X509_EXT_ISSUER_ALT_NAME             (1UL << 6)
#define MBEDTLS_OID_X509_EXT_SUBJECT_DIRECTORY_ATTRS     (1UL << 7)
#define MBEDTLS_OID_X509_EXT_BASIC_CONSTRAINTS           (1UL << 8)
#define MBEDTLS_OID_X509_EXT_NAME_CONSTRAINTS            (1UL << 9)
#define MBEDTLS_OID_X509_EXT_POLICY_CONSTRAINTS          (1UL << 10)
#define MBEDTLS_OID_X509_EXT_EXTENDED_KEY_USAGE          (1UL << 11)
#define MBEDTLS_OID_X509_EXT_CRL_DISTRIBUTION_POINTS     (1UL << 12)
#define MBEDTLS_OID_X509_EXT_INIHIBIT_ANYPOLICY          (1UL << 13)
#define MBEDTLS_OID_X509_EXT_FRESHEST_CRL                (1UL << 14)
#define MBEDTLS_OID_X509_EXT_NS_CERT_TYPE                (1UL << 16)
